...
//  platforms explicitly, effectively fixing mouse access on Raspberry Pi.
//  (#2837, #3950) 2020-05-25: Misc: Report a zero display-size when window is
//  minimized, to be consistent with other backends. 2020-02-20: Inputs: Fixed
//  mapping for ImGuiKey_KeyPadEnter (using SDL_SCANCODE_KP_ENTER instead of
...
static void ImGui_ImplSDL2_UpdateMousePosAndButtons() {
    ...
    if (g_Window == focused_window) {
        if (g_MouseCanUseGlobalState) {
            ...
            // workaround on SDL backends that have no global mouse position,
            // like Wayland or RPI
            int wx, wy;
